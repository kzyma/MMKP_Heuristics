 ...
 *                      or
 *
 *  filename <folder><name><number(optional)<mods><popSize><genMax><Seed>
 *
...
int main(int argc, char* argv[]){
    ...
    std::vector<std::tuple<int,float> > convData = BBA.getConvergenceData();
    ...
    std::cout<<BBA.getConvergenceGeneration()<<std::endl;
